    ...
    .config(['$httpProvider', 'RestangularProvider', 'settings', 'appConfig',
        ...
        RestangularProvider.addFullRequestInterceptor( function(element, operation, route, url, headers, params, httpConfig) {
            ...
            if(url.indexOf('yaas') < 0) {
                ...
                oldHeaders [settings.headers.hybrisClient] = appConfig.client();
                oldHeaders [settings.headers.hybrisClientId] = appConfig.clientId();
                oldHeaders [settings.headers.hybrisScopes] = appConfig.hybrisScopes();
